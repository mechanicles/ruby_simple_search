...
class TestUser < Minitest::Test
  ...
  class TestRubySimpleSearch < Minitest::Test
    ...
    def test_it_sets_attributes_properly
      expected_attributes = [:name, :email, :contact, :address]

      assert_equal expected_attributes, User.instance_variable_get("@simple_search_attributes")
    end
  ...
  class TestRubySimpleSearchWithoutBlock < Minitest::Test
  ...
  class TestRubySimpleSearchWitBlock < Minitest::Test
  ...
  class TestRubySimpleSearchWitSpecifiedAttributes < Minitest::Test
